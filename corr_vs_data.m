...
%------------------
% Potential Bad :
% Look nominal:  Figures 5,6,9,10,16
% Look mediocre: Figures 7,8,11,13,15,18,19,20
% Look poor: Figures 12,14,17
%
%----------------------------------------------------------------------
close all
clear
...
tic
% Good Correlation
S142Test = load('../All_VS/VS_Test/USDAS142.csv');
S142Train = load('../All_VS/VS_Train/USDAS142.csv');
...
S156Test = load('../All_VS/VS_Test/USDAS156.csv');
S156Train = load('../All_VS/VS_Train/USDAS156.csv');
...
S051Test = load('../All_VS/VS_Test/USDAS051.csv');
S051Train = load('../All_VS/VS_Train/USDAS051.csv');
...
S201Test = load('../All_VS/VS_Test/USDAS201.csv');
S201Train = load('../All_VS/VS_Train/USDAS201.csv');
...
S143Test = load('../All_VS/VS_Test/USDAS143.csv');
S143Train = load('../All_VS/VS_Train/USDAS143.csv');
...
S146Test = load('../All_VS/VS_Test/USDAS146.csv');
S146Train = load('../All_VS/VS_Train/USDAS146.csv');
...
S147Test = load('../All_VS/VS_Test/USDAS147.csv');
S147Train = load('../All_VS/VS_Train/USDAS147.csv');
...
S053Test = load('../All_VS/VS_Test/USDAS053.csv');
S053Train = load('../All_VS/VS_Train/USDAS053.csv');
...
S081Test = load('../All_VS/VS_Test/USDAS081.csv');
S081Train = load('../All_VS/VS_Train/USDAS081.csv');
...
S082Test = load('../All_VS/VS_Test/USDAS082.csv');
S082Train = load('../All_VS/VS_Train/USDAS082.csv');
...
S083Test = load('../All_VS/VS_Test/USDAS083.csv');
S083Train = load('../All_VS/VS_Train/USDAS083.csv');
...
S089Test = load('../All_VS/VS_Test/USDAS089.csv');
S089Train = load('../All_VS/VS_Train/USDAS089.csv');
...
S105Test = load('../All_VS/VS_Test/USDAS105.csv');
S105Train = load('../All_VS/VS_Train/USDAS105.csv');
...
S161Test = load('../All_VS/VS_Test/USDAS161.csv');
S161Train = load('../All_VS/VS_Train/USDAS161.csv');
...
S209Test = load('../All_VS/VS_Test/USDAS209.csv');
S209Train = load('../All_VS/VS_Train/USDAS209.csv');
...
S217Test = load('../All_VS/VS_Test/USDAS217.csv');
S217Train = load('../All_VS/VS_Train/USDAS217.csv');
...
S221Test = load('../All_VS/VS_Test/USDAS221.csv');
S221Train = load('../All_VS/VS_Train/USDAS221.csv');
...
S253Test = load('../All_VS/VS_Test/USDAS253.csv');
S253Train = load('../All_VS/VS_Train/USDAS253.csv');
...
S257Test = load('../All_VS/VS_Test/USDAS257.csv');
S257Train = load('../All_VS/VS_Train/USDAS257.csv');
...
S273Test = load('../All_VS/VS_Test/USDAS273.csv');
S273Train = load('../All_VS/VS_Train/USDAS273.csv');
